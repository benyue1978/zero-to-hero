...
# # tokenize it, and split into input and target sequences for training
# # overfit a small batch of it to make sure the training loop and loss calculation works
# import tiktoken
# enc = tiktoken.get_encoding('gpt2')
# with open('../input.txt', 'r') as f:
#     text = f.read()
...
train_loader = DataLoaderLite(B=B, T=T, process_rank=ddp_local_rank, num_processes=ddp_world_size) # adjust B to fit in memory, adjust T for context length (try 512 or 1024)
